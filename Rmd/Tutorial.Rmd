...
Due to their interaction with the terrestrial realm, we can expect that benthic invertebrate communities can be indirectly affected by logging

![Fig. 1: Various benthic macroinvertebrates under a stereo microscope. Source: G. Carter via NOAA/GLERL](benthicmacroinvertebrates_g.carter_noaa.jpg)
